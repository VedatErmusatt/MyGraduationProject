    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('general', 'Genel'), ('exercise', 'Egzersiz'), ('nutrition', 'Beslenme'), ('sleep', 'Uyku'), ('medication', 'İlaç Kullanımı'), ('mental', 'Mental Sağlık')], default='general', max_length=50, verbose_name='Kategori')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('water_intake', models.DecimalField(decimal_places=1, default=0, max_digits=4, verbose_name='Su Tüketimi (L)')),
